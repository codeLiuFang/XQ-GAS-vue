<template>
  <div style="margin:5px 5px;">
    <el-table :data="tabledata" border fit highlight-current-row style="" @selection-change="selectionchange" @row-click="rowclick('rowclick',arguments)" ref="asdytable">
...
export default {
  ...
  methods: {
    ...
    clearSelection() {
      this.$refs['asdytable'].clearSelection()
    }
  },
  watch: { // 当tabledata变化时
