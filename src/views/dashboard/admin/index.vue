<template>
  ...
  <el-col :span="8"> <el-input placeholder="请输入内容" v-model="name" style="padding-bottom:10px;">
          </el-input></el-col>
  <el-col :span="4"><el-button type="primary"  v-on:click="search">搜索</el-button>
   <el-button @click="resetForm()">重置</el-button></el-col>
  <el-col :span="4"><el-button type="primary" @click="addCompany('ruleForm')" >添加</el-button>
  <el-button type="success" @click="deletenames">批量删除</el-button></el-col>
 <!-- 新增企业弹窗start -->
